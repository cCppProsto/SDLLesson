...
{
  //m_fire_stream.load_frames(13);
  //m_fire_stream.load_frames(25);
  //m_fire_stream.load_frames(50);
  m_fire_stream.load_frames(75);

  m_texture.create_blank(256, 256);
}
//------------------------------------------------------------------------------
void game::draw()
{
...
{
  m_texture.lock();
  m_texture.copy_pixels(m_fire_stream.getBuffer());
  m_texture.unlock();
