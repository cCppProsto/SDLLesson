...
// http://www.lazyfoo.net/tutorials/SDL/04_key_presses/index.php
...
bool loadMedia()
{
  ...
  gKeyPressSurfaces[ index ] = loadSurface( "pics/press.bmp" );
  ...
  //Load up surface
  index = static_cast<int>(eKeyPressSurfaces::KEY_PRESS_SURFACE_UP);
  gKeyPressSurfaces[ index ] = loadSurface( "pics/up.bmp" );
  if( gKeyPressSurfaces[ index ] == nullptr )
  {
  ...
  //Load down surface
  index = static_cast<int>(eKeyPressSurfaces::KEY_PRESS_SURFACE_DOWN);
  gKeyPressSurfaces[ index ] = loadSurface( "pics/down.bmp" );
  if( gKeyPressSurfaces[ index ] == nullptr )
  {
  ...
  //Load left surface
  index = static_cast<int>(eKeyPressSurfaces::KEY_PRESS_SURFACE_LEFT);
  gKeyPressSurfaces[ index ] = loadSurface( "pics/left.bmp" );
  if( gKeyPressSurfaces[ index ] == nullptr )
  {
  ...
  //Load right surface
  index = static_cast<int>(eKeyPressSurfaces::KEY_PRESS_SURFACE_RIGHT);
  gKeyPressSurfaces[ index ] = loadSurface( "pics/right.bmp" );
  if( gKeyPressSurfaces[ index ] == nullptr )
  {
